...
const products = [
  { id: 1, name: 'Samsung 5-Door Flex Refrigerator', brand: 'Samsung', category: 'Kitchen', price: '₹2,32,000', link: 'https://amazon.com' },
  { id: 2, name: 'LG 65" OLED C3 Series TV', brand: 'LG', category: 'Living Room', price: '₹1,49,000', link: 'https://amazon.com' },
  { id: 3, name: 'IKEA MALM Bed Frame', brand: 'IKEA', category: 'Bedroom', price: '₹16,500', link: 'https://ikea.com' },
  { id: 4, name: 'Bosch Serie 6 Dishwasher', brand: 'Bosch', category: 'Kitchen', price: '₹70,500', link: 'https://amazon.com' },
  { id: 5, name: 'Dyson V15 Detect Vacuum', brand: 'Dyson', category: 'Home Appliances', price: '₹53,900', link: 'https://amazon.com' },
  { id: 6, name: 'Herman Miller Aeron Chair', brand: 'Herman Miller', category: 'Office', price: '₹1,15,800', link: 'https://amazon.com' },
  { id: 7, name: 'Whirlpool Front Load Washer', brand: 'Whirlpool', category: 'Laundry', price: '₹74,600', link: 'https://amazon.com' },
  { id: 8, name: 'KitchenAid Stand Mixer', brand: 'KitchenAid', category: 'Kitchen', price: '₹35,600', link: 'https://amazon.com' },
  { id: 9, name: 'Philips Hue Smart Lighting Kit', brand: 'Philips', category: 'Lighting', price: '₹16,500', link: 'https://amazon.com' },
  { id: 10, name: 'West Elm Mid-Century Sofa', brand: 'West Elm', category: 'Living Room', price: '₹1,57,600', link: 'https://westelm.com' },
  { id: 11, name: 'Nest Learning Thermostat', brand: 'Nest', category: 'Smart Home', price: '₹20,700', link: 'https://amazon.com' },
  { id: 12, name: 'Sony HT-A7000 Soundbar', brand: 'Sony', category: 'Entertainment', price: '₹1,07,800', link: 'https://amazon.com' },
  { id: 13, name: 'Tempur-Pedic Mattress', brand: 'Tempur-Pedic', category: 'Bedroom', price: '₹1,82,500', link: 'https://amazon.com' },
  { id: 14, name: 'Breville Barista Express', brand: 'Breville', category: 'Kitchen', price: '₹58,000', link: 'https://amazon.com' },
  { id: 15, name: 'Crate & Barrel Dining Set', brand: 'Crate & Barrel', category: 'Dining', price: '₹1,24,400', link: 'https://crateandbarrel.com' },
  { id: 16, name: 'GE Profile Smart Oven', brand: 'GE', category: 'Kitchen', price: '₹2,73,800', link: 'https://amazon.com' },
  { id: 17, name: 'Ashley Furniture Sectional', brand: 'Ashley', category: 'Living Room', price: '₹1,07,800', link: 'https://ashleyfurniture.com' },
  { id: 18, name: 'Pottery Barn Bed Frame', brand: 'Pottery Barn', category: 'Bedroom', price: '₹1,41,000', link: 'https://potterybarn.com' },
  { id: 19, name: 'Shark Robot Vacuum', brand: 'Shark', category: 'Home Appliances', price: '₹37,300', link: 'https://amazon.com' },
  { id: 20, name: 'Miele Complete C3 Vacuum', brand: 'Miele', category: 'Home Appliances', price: '₹99,500', link: 'https://amazon.com' },
];
